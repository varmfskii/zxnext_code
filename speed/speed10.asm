...
s35:
	...
	ld de,s70
	ld (branch+1),de
	ld de,screen+1*40+35 	; 3.5MHz field
	call copy_clr
	nextreg $07,$01		; 7MHz
	ei
	jp loop
s70:
	...
	ld de,s14
	ld (branch+1),de
	ld de,screen+2*40+35	; 7MHz field
	call copy_clr
	nextreg $07,$02		; 14MHz
	ei
	jp loop
s14:
	...
	ld de,s28
	ld (branch+1),de
	ld de,screen+3*40+35	; 14MHz field
	call copy_clr
	nextreg $07,$03		; 28MHz
	ei
	jp loop
s28:
	...
	ld de,s35
	ld (branch+1),de
	ld de,screen+4*40+35	; 28MHz field
	call copy_clr
...
copy_clr:	
	...
	org $8200
	.257 byte $80
	savenex open "speed10.nex",start
	savenex auto
	savenex close
