...
\paragraph{Layer 2 $320\times256$, Write only overlaid on ROM}
\begin{verbatim}
p_layer2: defl $123b
r_layer2: defb $70
start:
  ...
  ld a,$03       ; enable, wo, 1st 16k
  out (c),a
  ld a,$10       ; bank offset +0
  out (c),a
  call wrtpage
  ld bc,p_layer2
  ld a,$11       ; bank offset +1
  out (c),a
  call wrtpage
  ld bc,p_layer2
  ld a,$12       ; bank offset +2
  out (c),a
  call wrtpage
  ld bc,p_layer2
  ld a,$12       ; bank offset +3
  out (c),a
  call wrtpage
  ld bc,p_layer2
  ld a,$12       ; bank offset +4
  out (c),a
  call wrtpage
  ret
wrtpage:  
...
\paragraph{Layer 2 $640\times256$, Write only overlaid on ROM}
\begin{verbatim}
p_layer2: defl $123b
r_layer2: defb $70
start:
