...
%Opens the file corresponding to the filename pointed to by HL.
%
%Entry:
%\begin{itemize}
...
%\item[] E = Open action
%  \begin{itemize}
%  \item[] 0 - Error if file already exists
...
%Exit:
%\begin{itemize}
%\item[] New file: Carry set, Zero set
%\item[] Existing file: Carry Set, Zero clear
%\item[] Error: Carry clear, A = Error number
%\end{itemize}
