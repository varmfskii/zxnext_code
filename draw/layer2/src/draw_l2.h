...
void _hline_l2(UCHAR x0, UCHAR x1, UCHAR y, UCHAR c);
void _line_l2(UCHAR x0, UCHAR y0, UCHAR x1, UCHAR y1, UCHAR c);
void _vline_l2(UCHAR x, UCHAR y0, UCHAR y1, UCHAR c);
void circle_l2(UCHAR xc, UCHAR yc, UCHAR r, UCHAR c);
void cls_l2(UCHAR c);
void disc_l2(UCHAR xc, UCHAR yc, UCHAR r, UCHAR c);
void line_l2(short x0, short y0, short x1, short y1, UCHAR c);
void set_l2(UCHAR x, UCHAR y, UCHAR c);
void setmode_l2(void);
