...
$key = q/overline{hbox{INT}};MSF=1.6;LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG STYLE=""
 SRC="|."$dir".q|img55.svg"
...
$key = q/overline{hbox{NMI}};MSF=1.6;LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG STYLE=""
 SRC="|."$dir".q|img54.svg"
...
$key = q/{lstlisting}[language=C]unsignedcharesx_m_tapein_close(void)unsignedcharesx_m_tauint16_tblock)unsignedcharesx_m_tapein_toggle_pause(void){lstlisting};LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG STYLE=""
...
$key = q/{lstlisting}[language=C]unsignedcharesx_m_tapeout_close(void)unsignedcharesx_m_tme)unsignedcharesx_m_tapeout_trunc(unsignedchar*filename){lstlisting};LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG STYLE=""
